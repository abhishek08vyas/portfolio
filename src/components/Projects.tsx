...
import { SiSpringboot, SiDocker, SiPython, SiSwift, SiNextdotjs, SiTailwindcss, SiFlask, SiAmazons3, SiPostgresql, SiJunit5, SiSwagger, SiTensorflow, SiNodedotjs, SiMongodb, SiReact, SiFirebase, SiHeroku, SiFlutter } from "react-icons/si";
		...
		>
			...
			<div className={commonStyles.section.container}>
				...
				<div className="mb-12 text-center">
					<h2 className={commonStyles.header.title}>My Work</h2>
