	...
	return (
		...
		>
			<div className={commonStyles.section.container}>
						...
						>
							...
							<div className="relative h-48 overflow-hidden">
								...
								{hasAnyFeatured && project.featured && (
									<span className="absolute top-4 left-4 bg-white/85 backdrop-blur-sm text-xs font-medium px-2.5 py-1 rounded-full flex items-center shadow-sm text-[#2a2440]">
				...
				{/* Simplified Call to Action — dusk-purple gradient band */}
				<div className="mt-20 max-w-3xl mx-auto">
					<div className="rounded-[26px] p-6 md:p-8 shadow-[0_24px_60px_-24px_rgba(59,49,97,0.55)] text-center bg-gradient-to-br from-[#3b3161] via-[#6b5aa8] to-[#b8779b]">
						...
						<button
							...
							className="cursor-pointer group inline-flex items-center justify-center bg-white text-[#2a2440] font-semibold px-5 py-2 rounded-full text-sm transition-all hover:bg-white/90 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-[#3b3161]"
						>
