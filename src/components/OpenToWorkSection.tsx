								...
								<div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
									...
									<div className="flex flex-col sm:flex-row gap-3 shrink-0">
										<button
											...
											className={`${commonStyles.openToWork.button} w-full sm:w-auto cursor-pointer focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-[#382a1b]`}
										>
											<LuMail
										...
										<a
											href={RESUME_PATH}
											download
											className="group inline-flex items-center justify-center w-full sm:w-auto border border-white/50 text-white hover:bg-white/10 font-medium px-6 py-3 rounded-full transition-all whitespace-nowrap focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-[#382a1b]"
										>
											<LuDownload
