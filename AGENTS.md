...
- **Theme reality:** light theme only — no ThemeProvider/toggle is wired despite `next-themes` being installed. Don't design or audit against a dark mode that doesn't exist; call it out as a gap instead.
